...
<<<<<<< HEAD
import Header from "../components/Headerwatch";
import Categories from "../components/Categorieswatch";
import MoviesGrid from "../components/MoviesGridwatch"; 
import Footer from "../components/Footerwatch";
=======
